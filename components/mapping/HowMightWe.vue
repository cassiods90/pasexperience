<template>
    <div class="how-might-we mapping component-spaces">
        <span class="text title text-color04 title-spaces">How Might We’s</span>

        <div class="how-might-we-text title-spaces">
            <span class="text text-color04">
                By prioritizing these features and assigning them to the <b>Must, Could and Should Ship categories,</b> the development may take more
                informed and phased approaches, ensuring the most critical functionalities are implemented first while allowing for further expansion
                and refinement based on user feedback and evolving needs, in the future
            </span>
            <div class="ship-tags d-flex justify-content-start align-items-start">
                <span class="ship-tags-item must-item text semibold">Must Ship</span>
                <span class="ship-tags-item could-item text semibold">Could Ship</span>
                <span class="ship-tags-item should-item text semibold">Should Ship</span>
            </div>
        </div>

        <div class="how-might-we-more-text">
            <div class="more-text-items d-flex justify-content-between align-items-start">
                <div class="ship-tags d-flex justify-content-start align-items-start">
                    <span class="ship-tags-item must-item text title semibold">Must Ship</span>
                </div>
            ...
            <div class="more-text-items d-flex justify-content-between align-items-start">
                <div class="ship-tags d-flex justify-content-start align-items-start">
                    <span class="ship-tags-item could-item text title semibold">Could Ship</span>
                </div>
            ...
            <div class="more-text-items d-flex justify-content-between align-items-start">
                <div class="ship-tags d-flex justify-content-start align-items-start">
                    <span class="ship-tags-item should-item text title semibold">Should Ship</span>
                </div>
