<template>
    <div class="undestanding-problem">
        ...
        <div class="getting-started-more-text d-flex justify-content-between align-items-start">
            <div class="box-item box-left">
                <span class="text subtitle">What is the creator economy?</span>
                <span class="text">
                ...
                <div class="getting-started-links d-flex justify-content-start align-items-center">
                    ...
                    <a href="https://signalfire.com/creator-economy/" target="_blank" class="text small-text"
            ...
            <div class="box-item box-right">
                <span class="text subtitle">How could the creative economy grow in the future?</span>
                <span class="text">
